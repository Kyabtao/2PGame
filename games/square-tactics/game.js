/* Square Tactics — Place squares of different sizes. No overlaps allowed. Last to place wins. */
(function () {
  let starter = 1;
  Game.init({
    id: 'square-tactics',
    rules: [
      'Place squares of different sizes. No overlaps allowed. Last to place wins.',
